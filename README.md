...
#### Explicación de la solución
*se solicita ingresar un numero entero y se obtiene el residuo de ese numero entre 2, si el residuo es 0, el numero es par, en caso contrario es impar
...
#### Explicación de la solución
*se solicita ingresar 2 numeros reales, se divide el primero entre el segundo y si el residuo da 0, el primero es multiplo del segundo, en caso contrario, no lo es
...
#### Explicación de la solución
*se solicita una letra, se extrae el numero del codigo ascii que representa y se selecciona si es una vocal, en caso de que no, se revisa si es un simbolo, y si no es ni simbolo ni vocal, es una consonante
...
#### Explicación de la solución
*se solicita un numero real, y se calcula si es menor a la frecuencia de las ondas del espectro electromagnetico, si es menor a una, pertenece a esa
...
#### Explicación de la solución
*se solicita ingresar el nombre de un pais de América y se busca su coincidencia usando case, si se halla, se muestra un nmensaje con la capital del pais
